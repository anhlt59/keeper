# Keeper — Hệ Thống Quản Lý Tài Sản

> Phiên bản: 1.2.0 | Thư mục gốc: `/Users/anhlt/Projects/vibe/zoo/`
> Trạng thái: Phase 1/2 hoàn thành, Phase 3 đang chờ

**Keeper Asset Management System** là hệ thống quản lý tài sản doanh nghiệp tập trung, theo dõi toàn bộ vòng đời tài sản từ mua sắm đến thanh lý.
...
Hệ thống Keeper giải quyết các vấn đề:
